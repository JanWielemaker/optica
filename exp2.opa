/*  Saved optica configurations
    Saved at Thu Mar 26 15:08:15 1998
*/
...
config_file_time_stamp(8.90655e+08).

config_file_time_stamp(8.90659e+08).

config_file_time_stamp(8.90735e+08).

config_file_time_stamp(8.90735e+08).

config_file_time_stamp(8.90737e+08).

config_file_time_stamp(8.90741e+08).

config_file_time_stamp(8.90753e+08).

config_file_time_stamp(8.90917e+08).
...
Wat gebeurt er met het (virtueel) beeldpunt als een tweede lens op de
bank wordt gezet?

Op welke manier kan je de voorwerpsafstand, beeldsafstand en de
brandpuntsafstand van een lenzenstelsel bepalen?  Kan een lens met
dezelfde brandpuntsafstand en voorwerpsafstand het lenzenstelsel
vervangen?",
     [ show_at_open(true)
     ]).
...
<IMG SRC=""calc.xpm"">Rekenmachine.  Klik op icoon en je kunt rekenen met getallen
en met namen die je aan bepaalde waarden hebt toegekend.
...
<IMG SRC=""ideallensa.xpm"">Dunne lens A.

<IMG SRC=""parlamp.xpm"">Lampje met drie evenwijdige lichtstralen/

<IMG SRC=""consline.xpm"">Vertikale hulplijnen om afstanden te meten.

<IMG SRC=""hconsline.xpm"">Horizontale hulplijnen om hoogte te meten.
...
<IMG SRC=""ruler.xpm"">Lineaal om afstanden te meten.  Klik op icoon en vervolgens op de
hulplijn vanwaar je wil meten, houdt de muis ingedrukt, en laat weer los
op het punt tot waar je wil meten.  De afstand verschijnt vanzelf.

<IMG SRC=""protractor.xpm"">Meet hoek van de lichtstraal.  Klik op icoon en vervolgens op de
lichtstraal waarvan je de hoek wil meten.  De waarde van de hoek
verschijnt vanzelf.

<IMG SRC=""extbeam.xpm"">Trek een hulplijn.  Klik op het icoon en vervolgens op de lichtstraal
die je wil verlengen met een gekleurde hulplijn.  Kies daarna een kleur
voor de hulplijn.

<IMG SRC=""showgauge.xpm"">Maak meetwaarden zichtbaar.  Klik op dit icoon en alle meetwaarden
worden weer zichtbaar.

<IMG SRC=""switch.xpm"">Schakel lampen aan. Klik op dit icoon en de lampen worden aangezet.


<IMG SRC=""tool.xpm"">Instellen.  Klik op dit icoon en klik vervolgens op het object dat je
wil manipuleren. Een scherm verschijnt waar je waardes in kan stellen.

<IMG SRC=""rotlamp.xpm"">Draai een lichtbundel.  Klik op dit icoon en klik vervolgens op de
lichtbundel die je wil draaien.  Houdt de muis ingedrukt en sleep de
bundel in de gewenste hoek.

<IMG SRC=""xmove.xpm"">Beweeg object horizontaal.  Klik op icoon en sleep het object met de
muis.

<IMG SRC=""ymove.xpm"">Beweeg object vertikaal.  Klik op icoon en sleep het object met de
muis.

<IMG SRC=""snapr.xpm"">Verwijder object.  Klik op icoon en vervolgens op het object dat je
wil verwijderen.

<IMG SRC=""snapall.xpm"">Verwijder alle objecten.  Klik op dit icoon en bevestig dat je alles
wil verwijderen. De bank is daarna weer leeg.

<IMG SRC=""theory.xpm"">Bekijk theorie. Klik op icoon en theorie verschijnt.

<IMG SRC=""assignment.xpm"">Bekijk de opdracht. Klik op dit icoon en de opdracht verschijnt.


<IMG SRC=""calc.xpm"">Rekenen.  Klik op icoon en je kan berekeningen maken met cijfers en
namen die je aan waarden hebt toegekent.

<IMG SRC=""winhelp.xpm"">Help.  Korte uitleg over de instrumenten en objecten.  Klik op icoon
en hulp verschijnt.", []).
...
<IMG SRC=""rbulb.xpm"">Lamp met divergerende lichtbundel.


<IMG SRC=""consline.xpm"">Vertikale meetlijn.


<IMG SRC=""hconsline.xpm"">Horizontale meetlijn.


Instrumenten.
Je kunt met de instrumenten objecten manipuleren en meten.  Klik met de
muis eerst op het icoon van het instrument en vervolgens op het object
dat je wil manipuleren.

<IMG SRC=""ruler.xpm"">Meet afstanden.  Klik op dit icoon en vervolgens op de meetlijn
waarvan je wil meten.  Houdt de muis ingedrukt en sleep de muis naar de
plek tot waar je wil meten. Laat de muis los en de afstand verschijnt.

<IMG SRC=""protractor.xpm"">Meet hoek.  Klik op icoon en vervolgens op de lichtstraal waar je de
hoek van wil meten.  De waarde van de hoek die de lichtstraal met de
hoofdas maakt verschijnt.

<IMG SRC=""extbeam.xpm"">Trek hulplijn.  Klik op icoon en vervolgens op de lichtstraal die je
wil verlengen met een gekleurde hulplijn.

<IMG SRC=""showgauge.xpm"">Maak meetwaarden zichtbaar.  Klik op icoon en de meetwaarden die
verdwenen zijn doordat ze een verandering hebben ondergaan verschijnen
weer.

<IMG SRC=""calc.xpm"">Rekenen.  Klik op icoon en reken met getallen en met waarden die een
naam hebben gekregen.

<IMG SRC=""switch.xpm""> Schakel lampen aan. Klik op icoon en de lampen worden aangezet.

<IMG SRC=""tool.xpm"">Instellen.  Klik op icoon en vervolgens op het object dat je wil
manipuleren. Een scherm verschijnt waarbij je kan instellen.

<IMG SRC=""rotlamp.xpm"">Draai lichtbundel.  Klik op icoon, klik met de muis op de middelste
straal van de bundel die je wil draaien, houdt de muis vast en sleep de
bundel in de gewenste hoek.
...
<IMG SRC=""snapr.xpm"">Verwijder een object.  Klik op icoon en klik vervolgens op het object
dat je wil verwijderen.

<IMG SRC=""snapall.xpm"">Verwijder alle objecten.  Klik op icoon, bevestig dat je alles wil
verwijderen en de bank is weer leeg.

<IMG SRC=""theory.xpm"">Theorie bekijken. Klik op dit icoon en de theorie verschijnt.

<IMG SRC=""assignment.xpm"">Opdracht bekijken. Klik op dit icoon en de opdracht verschijnt.

<IMG SRC=""winhelp.xpm"">Help.  Korte uitleg over de objecten en instrumenten.  Klik op dit
icoon en hulp verschijnt.
...
<IMG SRC=""ideallens.xpm"">Instelbare lens.  Je kan de afstand van de lens vanaf het begin van
de bank en de brandpuntsafstand instellen.
...
Instrumenten:
Met de instrumenten kun je objecten manipuleren en metingen verrichten.
Klik eerst op het icoon van het instrument dat je wil gaan gebruiken en
vervolgens op het object dat je wil gaan manipuleren.

<IMG SRC=""ruler.xpm"">Meet afstanden.  Klik op icoon en klik vervolgens op de plek vanwaar
je wil meten.  Houdt de muis ingedrukt en sleep naar het punt tot waar
je wil meten. Laat de muis los en de afstand verschijnt.

<IMG SRC=""protractor.xpm"">Meet hoek.  Klik op icoon en vervolgens op de lichtstraal waarvan je
de hoek wil meten.  De waarde van de hoek die de lichtstraal met de
hoofdas maakt verschijnt.

<IMG SRC=""extbeam.xpm"">Trek een hulplijn.  Klik op dit icoon en vervolgens op de lichtstraal
die je wil verlengen met een gekleurde hulplijn.  Kies een kleur en de
hulplijn verschijnt.

<IMG SRC=""showgauge.xpm"">Maak meetwaarden zichtbaar.  Klik op icoon en de waarde die veranderd
zijn worden weer zichtbaar.

<IMG SRC=""switch.xpm"">Schakel lampen in. Klik op dit icoon en de lampen worden weer aangezet.

<IMG SRC=""calc.xpm"">Rekenen.  Klik op icoon en reken met getallen of met waarden die je
een naam hebt gegeven.

<IMG SRC=""tool.xpm"">Instellen.  Klik op dit icoon en klik vervolgens op het object dat je
wil manipuleren.  Een scherm verschijnt waarbij je waarden in kan
stellen.

<IMG SRC=""rotlamp.xpm"">Draai een lichtbundel.  Klik op icoon en klik vervolgens op de
middelste straal van de lichtbundel die je wil draaien.  Houdt de muis
ingedrukt en sleep de bundel in de gewenste hoek.

<IMG SRC=""xmove.xpm"">Beweeg een object horizontaal.  Klik op icoon en sleep object met de
muis.

<IMG SRC=""ymove.xpm"">Beweeg een object vertikaal.  Klik op icoon en sleep object met de
muis.

<IMG SRC=""snapr.xpm"">Verwijder een object.  Klik op icoon en klik vervolgens op het object
dat je wil verwijderen.

<IMG SRC=""snapall.xpm"">Verwijder alle objecten.  Klik op icoon en bevestig dat je alles wil
verwijderen. De bank is dan weer leeg.

<IMG SRC=""theory.xpm"">Bekijk theorie. Klik op icoon en theorie verschijnt.

<IMG SRC=""assignment.xpm"">Bekijk opdracht. Klik op icoon en de opdracht verschijnt.

<IMG SRC=""winhelp.xpm"">Help.  Bevat korte uitleg over objecten en instrumenten.  Klik op
icoon en hulp verschijnt.", []).
...
uitgezonden door<I><B> <B>lichtbronnen</B></B></I>, bijvoorbeeld een gloeilamp, een TL-buis
...
links en naar rechts verschoven worden.  Je kan slechts een lens
tegelijk op de werkbank zetten.
...
Als een evenwijdige lichtbundel op een <B>positieve</B> lens
valt, dan blijkt dat de uittredende lichtstralen door een punt gaan.
Dit wordt het <B>brandpunt</B> van een positieve lens genoemd.  De
<B>brandpuntsafstand</B> <B>f</B> is de afstand van de lens tot het brandpunt.

Als een evenwijdige lichtbundel op een <B>negatieve</B> lens
valt dan <B>lijkt</B> <B>het</B> alsof de uittredende stralen uit een punt komen links
van de lens.  Dit punt wordt het <B>brandpunt</B> van een negatieve lens
genoemd.  De <B>brandpuntsafstand</B> <B>f</B> van een negatieve lens is de
afstand van de lens tot het brandpunt en krijgt een negatieve waarde.

De drie lenzen die je in fase 2 voor je experimenten gaat gebruiken zijn
dunne lenzen van enkele milimeters.  Deze worden voorgesteld als een
dikke streep.
",
     [ show_at_open(true)
     ]).
...
lenzen, ook wel <B>lenzenstelsel</B> genoemd.  Fase 4 gaat over 
<B>beeldvorming</B> met lenzenstelsels.  Ook in deze fase gebruik je als
voorwerp de lamp met de divergerende lichtbundel.  

Een lenzenstelsel vormt op dezelfde manier beelden als een enkele lens.
Ook bij een lenzenstelsel is er dus sprake van vergroting, van een
voorwerpsafstand en beeldsafstand, van een brandpuntsafstand en geldt er
de vergrotingsformule en de lenzenformule.  Een lenzenstelsel zou je dus
kunnen <B>vervangen</B> door een enkele lens die dezelfde brandpuntsafstand en
dezelfde voorwerpsafstand heeft als het lenzenstelsel.",
     [ show_at_open(true)
     ]).
